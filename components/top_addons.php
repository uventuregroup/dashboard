...
<div class="ui-span-font-xs">TOP ADD-ON PRODUCTS BY SALES</div>
<ol data-role="listview" data-inset="true">
	<?php $ProductNum = 0; foreach ($ResponseXML->product as $NextProduct) { $ProductNum++; ?>
		...
		<li><a href="<?php echo "product-dashboard.php?productID=". $NextProduct->id; ?>"><h2><?php echo $ProductDesc; ?></h2> <span class="ui-li-count"><?php echo StringFormat::Currency($NextProduct->dollars) ." sales"; ?></span></a></li>
	<?php } ?>
</ol>
